...
define(['app'], function (app) {
	 ...
	 var employeesController = function ($rootScope, $scope, $modal, _, $filter, messageService, 
    ...
    app.register.controller('employeesController', ['$rootScope', '$scope', '$modal', '_', '$filter', 'messageService', 'userService', 

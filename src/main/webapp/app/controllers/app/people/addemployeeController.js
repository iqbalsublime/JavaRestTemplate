...
define(['app'], function (app) {
	 ...
	 var addemployeeController = function ($rootScope, $scope, _, messageService, 
    ...
    app.register.controller('addemployeeController', ['$rootScope', '$scope', '_', 'messageService', 'userService', 'roleService',
    'constantService', 'navigationService', 'localStorageService','configurationService', 'ngProgress', 'loadService', '$upload', 
    '$http', 'authorizationService', 'modalService', '$routeParams', addemployeeController]);
